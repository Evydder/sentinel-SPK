...
sentinel_cfg = SparksConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_sparksd_proto_version_with_sentinel_ping = 70207
...
def get_sparks_conf():
    ...
    sparks_conf = sentinel_cfg.get('sparks_conf', sparks_conf)
