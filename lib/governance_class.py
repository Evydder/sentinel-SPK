...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to sparksd "gobject list" output
    ...
    def sparksd_serialise(self):
        import sparkslib
        return sparkslib.SHIM_serialise_for_sparksd(self.serialise())
